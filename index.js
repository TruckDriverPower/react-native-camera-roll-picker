...
import { CameraRoll, Platform, StyleSheet, View, Text, ListView, ActivityIndicator } from "react-native";
...
class CameraRollPicker extends Component {
  ...
  render() {
    ...
    var { scrollRenderAheadDistance, initialListSize, pageSize, removeClippedSubviews, imageMargin, backgroundColor, emptyText, emptyTextStyle } = this.props;
    ...
    return (
      <View style={[styles.wrapper, { padding: imageMargin, paddingRight: 0, backgroundColor: backgroundColor }]}>
        {listViewOrEmptyText}
      </View>
    );
  }
  ...
  _renderImage(item) {
    ...
    return <ImageItem key={uri} item={item} selected={isSelected} imageMargin={imageMargin} selectedMarker={selectedMarker} imagesPerRow={imagesPerRow} containerWidth={containerWidth} onClick={this._selectImage.bind(this)} />;
  }
